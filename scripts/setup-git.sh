...
say ""
say "That is enough for correct author info on commits. To push to GitHub you also need to sign in once"
say "(browser/HTTPS credential manager, SSH key, or \`gh auth login\`)."
